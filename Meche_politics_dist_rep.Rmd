...
(b) This section contains leave-one-out cross-validation model comparisons between the Bayesian models from part 'a' for cities with multiple regressions in the original analysis. As you can see, the relative-best models in the LOO-compared models are the models for which I provide density overlay plots below in part 'c'.


## LOO-Comparisons: Lima, Peru
...
## LOO-Comparisons: Santiago, Chile
...
pred_s2 <- posterior_linpred(santreg2)
summary(pred_s2[1,])
...
pred_s3 <- posterior_linpred(santreg3)
summary(pred_s3[1,])
...
print((fit_t2_s4), digits = 3)

pred_s4 <- posterior_linpred(santreg4)
summary(pred_s4[1,])
