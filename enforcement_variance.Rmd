...
al;sdkfja;sldkfj;a
as;dflkja;sdlfkja;
adsf;lakjs;dflkajs;d
as;dflkjja;slkfjd;askl
...
I was unable to recreate one graphic on account of not having access to political adn temporal data that would allow me to create teh graphic showing class gradient, budget, operations, and politicians in power for certain time frames. Otherwise, I have replicated or attempted to replicate all of the major analyses in the paper with the data I have access to. The preliminary supply/demand graphic in the paper is one made from dummy data as a means to mock up the concept in the introduction and not an analysis core to the data itself. 
